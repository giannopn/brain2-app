...
## Διαφοροποιήσεις από το πρωτότυπο σχέδιο στο Figma

Η τελική εφαρμογή ακολουθεί το πρωτότυπο στο Figma στα περισσότερα σημεία και στην κύρια λογική της εφαρμογής,
με μερικές διαφοροποιήσεις στην πλοήγηση και στη σχεδίαση, ώστε να συμβαδίζει με όλες τις υλοποιημένες λειτουργίες.
Συγκεκριμένα:
- Δεν υλοποιήθηκε η αποθήκευση των subscriptions, καθώς με την αποθήκευση των bills καλύπτονται όλες οι 
λειτουργικότητες που σχετίζονται με τους άξονες που επιλέχθηκαν. Επιλέχθηκε, επομένως, να μην υπερφορτωθεί 
η εφαρμογή με διαφορετικούς τύπους δεδομένων, αλλά να δοθεί έμφαση στα bills και στη βελτιστοποίηση των 
σχετικών λειτουργιών, διατηρώντας την απλότητα και την ευχρηστία της εμπειρίας χρήσης.
- Προστέθηκαν οθόνες για Sign-up / Sign-in, ώστε η σύνδεση να πραγματοποιείται με εισαγωγή email και 
τη χρήση one-time password ή magic link.
- Έγιναν πολύ μικρές αλλαγές και προσθήκες σε ορισμένα εικονίδια, γραφικά και overlays.